...
<head>
    ...
    <style type="text/css">
      body{
        background-color:rgba(12, 30, 48, 0.993);
      }

      button{
        transition: 1.5s;
        background-color: rgba(52, 44, 155, 0.657);
      }
      button:hover{
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  <div class="container-fluid">
    <a class="navbar-brand" href="index.html">Demo Bank   </a>
...
<div class="container">
            ...
            <div class="row">
                ...
                ?>
                    <tr style="color : white;">
                        ...
                        <td><a href="selectuserdetail.php?id= <?php echo $rows['id'] ;?>"> <button type="button" class="btn" >Transfer money</button></a></td> 
                    </tr>
                <?php
                    }
                ?>
        ...
        <script>
          ...
          document.getElementById("copyright").innerHTML = "&copy "+currYear+"  <b>Nepal Sharvani</b> </br>Intern, The Sparks Foundation";
        </script>
